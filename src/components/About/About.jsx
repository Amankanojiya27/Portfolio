...
const About = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col-reverse lg:flex-row justify-between items-center max-w-7xl mx-auto">
        {/* Left Side */}
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end z-1 ">
          <Tilt
            className="w-48 h-48 sm:w-64 sm:h-64 md:w-[30rem] md:h-[32rem] border-4 border-purple-700 rounded-full"
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.05}
          ...
          >
            <img
              ...
              alt="Aman Kanojiya"
              className="w-full h-full rounded-full object-cover object-contai drop-shadow-[0_10px_20px_rgba(130,69,236,0.5)]"
            />
          </Tilt>
        </div>
      </div>
